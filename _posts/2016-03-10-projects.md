...
| LTU Visual Commincation OP_02 "Case Study House" Assignment | Learning to visualize architecture as three-dimensional constructs and environments, which can also be organized into two-dimensional information. Modeling Case Study House #20b (Bass House, designed by Buff, Straub & Hensman 1958) |
